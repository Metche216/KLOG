# Generated by Django 3.2.25 on 2025-04-01 21:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='baseplayer', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Tournament',
            fields=[
                ...
                ('players', models.ManyToManyField(blank=True, to='core.BasePlayer')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tplayer', to='core.baseplayer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('players', models.ManyToManyField(to='core.TournamentPlayer')),
